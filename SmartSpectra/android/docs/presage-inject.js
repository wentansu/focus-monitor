// SmartSpectra Android SDK Documentation - Header/Footer Injection
(function() {
    'use strict';
    ...
    function init() {
        ...
        stylesLink.href = '/android/presage-dokka.css';
        stylesLink.rel = 'stylesheet';
        document.head.appendChild(stylesLink);

        // Wait for Dokka to fully load, then inject
        setTimeout(() => {
            injectHeader();
            injectFooter();
        }, 500);
        ...
        header.innerHTML = `
            <div class="presage-header-content">
                ...
                <nav class="presage-nav">
                    ...
                    <a href="https://docs.physiology.presagetech.com/android/index.html" class="active">Android</a>
